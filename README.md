...
---
3. 파일에 적힌 숫자 순서대로 작업을 진행하였습니다. 즉, 1_web_crawl.ipynb를 통해 데이터 크롤링을 진행하고, 2_token.ipynb를 통해 토큰화를 실행하였으며, 3_easy_model_lstm.ipynb를 통해 간단히 모델 학습을 진행하고, 4_fine_tuning.ipynb를 통해 미리 학습된 모델을 활용해 진행하였고, 유사하게 [ainize](https://ainize.ai/teachable-nlp)를 통해 일종의 파인튜닝을 진행한 것을 5_use_ainize.ipynb에서 확인하실 수 있습니다.
---
